//
// Credits to http://stackoverflow.com/a/24443602/844142
...
namespace Remotus.API
{
    public class NamespaceHttpControllerSelector : DefaultHttpControllerSelector
    {
        ...
        public override HttpControllerDescriptor SelectController(HttpRequestMessage request)
        {
            ...
            if (routeData?.Route?.DataTokens?["Namespaces"] == null) 
            ...
            if (string.IsNullOrEmpty(controllerNameAsString))
                return base.SelectController(request);
            ...
            else
            {
                ...
                var matchedType = _duplicateControllerTypes.Value
                ...
                if (matchedType != null)
                {
                    controllerDescriptor =  new HttpControllerDescriptor(_configuration, controllerNameAsString, matchedType);
                }
                else
                {
                    // Use default selector
            ...
            if (controllerDescriptor != null && controllerDescriptor.ControllerType != null)
            {
                ...
                var valid = string.Equals(controllerDescriptor.ControllerType.Name,
                    controllerNameAsString + ControllerSuffix, StringComparison.OrdinalIgnoreCase) &&
                    namespaces.Contains(controllerDescriptor.ControllerType.Namespace, StringComparer.OrdinalIgnoreCase);
                if (!valid)
