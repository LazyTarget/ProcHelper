...
{
    public class ToggleAudioDeviceMutedFunction : IFunction, IFunction<AudioDevice>
    {
        ...
        public ToggleAudioDeviceMutedFunction()
        {
        ...
        public class Descriptor : IFunctionDescriptor
        {
            ...
            public string Name => "Toggle audio device muted";
            ...
            {
                return new ToggleAudioDeviceMutedFunction();
            }
        }
