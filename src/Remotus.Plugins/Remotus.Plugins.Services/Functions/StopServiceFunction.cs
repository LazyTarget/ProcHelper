...
{
    public class StopServiceFunction : IFunction<WinServiceDto>
    {
        private readonly IWinServiceHelper _serviceHelper = new WinServiceHelper();

        public StopServiceFunction()
        {
        ...
        public async Task<IFunctionResult<WinServiceDto>> Execute(IExecutionContext context, IFunctionArguments arguments)
        {
            try
            {
                ...
                var res = _serviceHelper.StopService(serviceName);
        ...
        {
            public string ID => "7DE9A9C8-740E-42AC-BC8F-AD22790A4725";
            ...
            {
                return new StopServiceFunction();
            }
        }
